...
const INTEGRATION_LOGOS: Record<string, React.ReactNode> = {
  ...
  GitHub: <img src="https://cdn.simpleicons.org/github/1A1612" alt="" className="h-[18px] w-[18px]" />,
  Fireflies: <img src="https://cdn.simpleicons.org/fireflies/7B4DBE" alt="" className="h-[18px] w-[18px]" />,
  Jira: <img src="https://cdn.simpleicons.org/jira/0052CC" alt="" className="h-[18px] w-[18px]" />,
  ClickUp: <img src="https://cdn.simpleicons.org/clickup/7B68EE" alt="" className="h-[18px] w-[18px]" />,
  WhatsApp: <img src="https://cdn.simpleicons.org/whatsapp/25D366" alt="" className="h-[18px] w-[18px]" />,
  "Google Calendar": (
    <img src="https://cdn.simpleicons.org/googlecalendar/4285F4" alt="" className="h-[18px] w-[18px]" />
  )
};
    ...
    <div className="solid-card p-6">
      <div className="flex items-center gap-2">
        ...
        <div className="min-w-0 flex-1">
          ...
          <p className="mt-0.5 font-sans text-[11px] text-[#78716C]">Latest changes & decisions</p>
        </div>
        <button type="button" onClick={onViewAll} className="ml-auto flex-shrink-0 font-sans text-[11px] text-[#B8543D]">

...
export function AppShell() {
  ...
  const socratesWidth = socratesOpen ? SOCRATES_WIDTH : 0;
    ...
    <div className="flex h-screen overflow-hidden bg-bg">
      ...
      <div className="relative flex min-h-0 min-w-0 flex-1">
        ...
        <motion.button
          type="button"
          initial={false}
          animate={{ left: socratesWidth }}
          transition={navTransition}
          onClick={() => setSocratesOpen((open) => !open)}
          className="absolute top-1/2 z-[60] flex h-9 w-5 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-r-md border border-l-0 border-[rgba(26,22,18,0.08)] bg-white text-[#78716C] shadow-[2px_0_8px_rgba(26,22,18,0.06)] transition-colors hover:border-[#B8543D] hover:text-[#B8543D]"
